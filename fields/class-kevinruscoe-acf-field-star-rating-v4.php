...
class kevinruscoe_acf_field_star_rating extends acf_field {
	...
	*/
	...
	function __construct( $settings )
	{
		...
		$this->category = __("Basic",'acf-star-rating'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'acf-star-rating'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'acf-star-rating'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'acf-star-rating'),
				'something_else' => __('Something Else', 'acf-star-rating'),
			)
		));
