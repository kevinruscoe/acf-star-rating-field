...
class AcfStarRating4 extends acf_field
{
    protected $settings = [];
    ...
    public function create_options($field)
    {
        ...
        printf(
            $html,
            $this->name,
            _e("Maximum Rating", 'acf-star_rating'),
            _e("Maximum number of stars", 'acf-star_rating'),
            ...
            $this->name,
            _e("Return Type", 'acf-star_rating'),
            _e("What should be returned?", 'acf-star_rating'),
            do_action('acf/create_field', array(
                'type' => 'select',
     ...
     * format_value()
     *
     * This filter is applied to the $value after it is loaded from the
     ...
     *
     * This filter is applied to the $value after it is loaded from the
     * db and before it is passed back to the API functions such as the_field
     *
     * @type    filter
     * @since   3.6
     * @date    23/01/13
